...
class AdminTable(models.Model):
    ...
    admin_psw = models.CharField(max_length=45, blank=True, null=True)
...
class VideoName(models.Model):
    ...
    video_name = models.CharField(max_length=45, blank=True, null=True)
...
class VideoplayerStudentinfo(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'videoplayer_studentinfo'
